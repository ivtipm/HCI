...
Первая часть заданий будет продолженим предыдущих.
...
Оставлять комментарии и задвать вопросы, если что-то не понятно, можно в slack, желательно в общем канале (hci).
