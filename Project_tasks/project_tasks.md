...
переход в корзину возможен почти с любой страницы сайта  интернет магазина.
...
4. Создайте как минимум два варианта как минимум одного макета. Варианты должны отличаться не стилем (цветом, шрифтами, изображениями), а компоновкой и набором элементов интерфейса. 
...
4. Какую часть функционала предоставляет макет? Соотнесите это с
диаграммой вариантов использования.
5. Если были описаны персонажи (задание 3): удовлетворяет ли созданный
макет целям персонажей?
