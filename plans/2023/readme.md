# Экзамен
Изучите учебное пособие, в том числе те темы, которые не были рассмотренны на лекциях.

**Допуск на экзамен**:\
Максимальная оценка 3 если сдано:
- Доклад о предлемах интерфейса
- Одна программа на Lazarus, защита работы
- Грубый макет
- Одна из работ проекта: персонажи, варианты использования, даиграмма информационной ахитектуры

# Бонусные задания
- mind map курса
- диаграмма потока (задачи или экраны)
- Типографика (https://raw.githubusercontent.com/ivtipm/HCI/master/%D0%A7%D0%9C%D0%92.%20%D0%97%D0%B0%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F.pdf)
