...
- понятный, удобный, лаконичный и эстетичный дизайн окна:
  - назначения полей ввода и других лементов интерфейса понятно,
  - логичный порядок рсположения элементов,
  - аккурантное расположение элементов и выравнивание, 
  - правило близости и правило "внутрение расстояния <= внешние" соблюдаются,
  - элементы интерфйеса расположены компактно
...
- Конспект: Создание программ с графическим интерфейсом пользователя на Lazarus
  ...
  - Рекоменжуется выпонялть конспект в онлайн документах, Obsidian, Notion или подобных сервисах.
...
# Лекция 3. Приницп близости. Lazarus: Memo, якоря,
10 марта
...
# Лекция 4. Юзабилити. GOMS
13 марта
1. Повторение. Опрос.
1. Парадигмы UI?
1. Lazarus: Memo. Якоря (привязки). Свойства элементов: шрифт, цвет. Проверка входных данных. О диалоговых окнах.
2. Оценка юзабилити: модель GOMS. См. раздел 6.4. учебного пособия.
