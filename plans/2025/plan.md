...
- Рекомендуется заранее подготовить материалы для ответа: заметки, изображения с примерами, сайты или программы для демонстрации примеров. Можно использовать электронную доску, документ или любой другой 
