...
- В версии Lazarus 4.0 можно сразу выбрать режим работы с одним окном (Modern IDE (single-window))

<img src="Welcome_to_lazarus.png" width=400 >
...
# Практика 3. Доклады. Lazarus
1. Принцип близости, внутреннее < внешнее, разделители и др. эмпирические правила восприятия и дизайна. См. раздел 3.2 учебного пособия.
1. Lazarus: Memo. Якоря (привязки). Свойства элементов: шрифт, цвет. Проверка входных данных. О диалоговых окнах.

# Лекция 2. UI
1. UI. Виды.
2. Парадигмы проектирования интерфейсов
1. CLI в Lazarus
2. Юзабилити


# Задание 4. Бонус. Интеллект-карта.
...
# Лекция 3. Юзабилити. Оценка юзабилити.
1. Юзабилити
2. Оценка юзабилити: модель GOMS.


# Лекция 4. Проектирование UI в рамках проектирования продукта
1. Этапы проектирования: стратегия, возможности, структура, компоновка, готовый UI 
...
- Информационная архитектура. Диаграммы в Figma
- Диаграммы потока, задач, экранов
- Макетная сетка
...
# Экзамен
15/16 июня, 9.00, ауд 401

- Можно получить оценку удовлетворительно автоматически (при вашем согласии) после выполнения необходимого минимума работ.
- Отвечая по билету можно получить оценку удовлетворительно или выше. 

**Минимум работ**
- доклад
- Lazarus. Простая программа
- Lazarus. StringGrid
Проект:
- макет
- 1 другая работа

В таблице бонусные пункты и работы отмечены курсивом. Они ни всходят в минимум или критерия допуска на экзамен.
...
- Выбирается случайно
- 3 основных вопроса
- Вопросы могут совпадать с одной из ранее сданных работ (например Персонажи)\
  Поэтому приносите все работы на экзамен.


**Подготовка и ответ**
- Время подготовки к ответу - 1 астрономический час
- Во время подготовки можно использовать любые источники, кроме ИИ ассистентов. За использование ИИ ассистента вы можете быть удалены с экзамена.
- Рекомендуется заранее подготовить материалы для ответа: заметки, изображения с примерами, сайты или программы для демонстрации примеров.\
  Можно использовать заметки сделанные вручную, в электронном документе (word, obsidian и др.), электронный доску (excalidraw и др).
- Во время ответа по билету можно пользоваться всеми материалами, которые вы подготовили *самостоятельно* во время экзамена или заранее. Но если ответ по билету представлен только в виде чтения подготовленного материала - он не засчитывается.

- Будет дополнительные вопросы, не входящие в билет, но и не требующие развёрнутого ответа. Это нужно чтобы определить, готовились ли вы исключительно к ответу на вопросы одного конкретного билета, или у Вас есть знания по курсу в целом. 

**Оценка за курс**
- При выставлении оценки учитывается ответ по билету, ответ на дополнительные вопросы, своевременность выполнения работ, полнота выполнения работ.
