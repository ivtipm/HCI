...
Примерный список теоретических вопросов:
1. Типографика
...
6. Юзабилити
7. Этапы проектирования UX: информационная архитектура, навигация, диаграммы потока
8. Пользовательские модели, их место в проектировании уровней UX
9. Figma: основные элементы (текст, фреим, прямоугольник), компоненты, стили
10. Дизайн: цвета, цветовые модели, решётка Германа, дизайн-система
11. Принципы гештальта; ошибки восприятия
12. Интерфейс, классификация
13. Когнитивная психология: внимание, ментальные модели, память, автоматичные задачи
15. Создание приложений c GUI в Lazarus: кнопки, поля ввода, лейблы, привязки, MVC
16. Создание приложений c GUI в Lazarus: проверка входных данных, горячие клавиши, порядок обхода элементов, как правильно сообщать от ошибках

Во время ответа на вопрос приводите примеры. Можно писать, рисовать, показывать изображения.

Во время ответа по билету нужно будет ответить на небольшой дополнительный вопрос без подготовки.

Практические вопросы:
- Защита работы по проекту.

Экзаменационная оценка включает в себя полноту и своевременность выполнения работ в течении семестра. 
...
- Настройки привязки (anchors) для элементов интерфейса. Размер поля для отчётов (memo) должен увеличиваться при изменении размеров кона. 
- Защита работ
...
- Дополните конспект по Лазарусу:
...
-  добавьте отдельный метод для считывания данных из полей ввода; переменные, в которых хранятся значения, сделайте глобальными
  ...
  - сообщайте пользователю о некорректных данных
...
- Напишите комментарии к процедурам, функциям, переменным; поясняющие комментарии к новым для вас процедурам и компонентам
- пример https://github.com/ivtipm/HCI/tree/master/Lazarus-examples/Memo_Menu
