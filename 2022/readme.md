...
- Конспект (бонусный): Human interface guidelines (руководство по дизайну интерфеса).  
...
- Добавьте подсказки о горячих клавиших; в элементах меню напишите горячие клавиши
- Защита работ
